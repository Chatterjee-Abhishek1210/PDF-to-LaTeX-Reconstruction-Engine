...
/**
 * Reusable inline SVG icons for premium, clean UI without raw emojis.
...
export const LaTeXIcon = ({ size = 16, className = '' }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const CompareIcon = ({ size = 16, className = '' }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const ExportIcon = ({ size = 16, className = '' }) => (
  ...
  >
    ...
    <polygon points="12 12 3 6.92 12 1.84 21 6.92" />
    <polyline points="12 5.06 17.5 8.24 17.5 14.54" />
  </svg>
)

export const ColorIcon = ({ size = 16, className = '' }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
    ...
    className={className}
  >
    <path d="M12 22C17.52 22 22 17.52 22 12S17.52 2 12 2 2 6.48 2 12s4.48 10 10 10zm0-18c4.41 0 8 3.59 8 8s-3.59 8-8 8-8-3.59-8-8 3.59-8 8-8z" />
...
export const TypographyIcon = ({ size = 16, className = '' }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const TableIcon = ({ size = 16, className = '' }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
...
export const EquationIcon = ({ size = 16, className = '' }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
    ...
    className={className}
  >
    <path d="M4 19h16M4 5h16M4 5l8 7-8 7" />
  </svg>
)
...
export const FailedIcon = ({ size = 16, className = '' }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
